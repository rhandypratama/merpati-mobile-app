...
class AuthController extends GetxController {
  ...
  // Rxn<UserModel> googleUser = Rxn<UserModel>();
  ...
  signInWithGoogle() async {
    try {
      ...
      var errorMessage;
      showLoadingIndicator(modalColor: Colors.black.withOpacity(0.3));
      if (kIsWeb) {
        ...
        log('HOLLLAA ===> ${googleUser.toString()}');
      ...
      hideLoadingIndicator();
      // if (e.toString()=='CANCELLED_SIGN_IN') print('cancellllllll');
